...
export default function FullPlayer({ song, isPlaying, queue, queueIndex, audioRef, ytPlayerRef, onTogglePlay, onPrev, onNext, onSeek, onVolume, shuffle, onToggleShuffle, repeat, onToggleRepeat, onClose }) {
      ...
      <div className={`fp-body ${showQueue ? 'with-queue' : ''}`}>
        <div className="fp-main">
          ...
          <div className="fp-controls">
            <button className={`fp-btn ${shuffle ? 'active' : ''}`} onClick={onToggleShuffle}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
                <path d="M10.59 9.17L5.41 4 4 5.41l5.17 5.17 1.42-1.41zM14.5 4l2.04 2.04L4 18.59 5.41 20 17.96 7.46 20 9.5V4h-5.5zm.33 9.41l-1.41 1.41 3.13 3.13L14.5 20H20v-5.5l-2.04 2.04-3.13-3.13z"/>
              </svg>
            </button>
            <button className="fp-btn" onClick={onPrev}>
            ...
            <button className="fp-btn" onClick={onNext}>
              <svg width="28" height="28" viewBox="0 0 24 24" fill="currentColor">
                <path d="M6 18l8.5-6L6 6v12zM16 6v12h2V6h-2z"/>
              </svg>
            </button>
            <button className={`fp-btn ${repeat > 0 ? 'active' : ''}`} onClick={onToggleRepeat}>
              <svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor">
